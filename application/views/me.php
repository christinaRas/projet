        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-8 text-white">
                    <h1>Hello <?php echo $this->session->userdata('nom') ;?></h1>
                    <p>
                        Bienvenue sur Zay!
                    </p>
                </div>
        ...
        <?php foreach($resultat as $R): ?>
                ...
                <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                <a href="shop-single.html" class="h3 text-decoration-none"><?php echo $R->descri; ?></a>
                                ...
                                <p class="text-center mb-0"><?php echo $R->prix; ?></p>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
